...
class OthersProfile extends StatefulWidget {
  String uid;
  OthersProfile({Key? key,required this.uid}) : super(key: key);
  static const String id="other_profile";

  @override
  State<OthersProfile> createState() => _OtherPageState();
}

class _OtherPageState extends State<OthersProfile> {
    ...
    return ListTile(
      onTap: () {
        Navigator.push(
            context,
            MaterialPageRoute(
                builder: (context) => OthersProfile(uid: user.uid)));
      },
